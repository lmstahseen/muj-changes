...
import { ChevronDown, Users, Video, MessageCircle, TrendingUp, BarChart3, Play, VideoOff, Crown, Clock, UserPlus, AlertCircle, Target, Star, Award, Calendar, DollarSign, Info, Vote } from 'lucide-react';
...
import { CommunityFinancials } from './CommunityFinancials';
import { Community, CommunityMember, formatStakeAmount, formatDate, getDaysLeft, getTimeUntilStart } from '../lib/supabase';
...
export function CommunityDetail() {
  ...
  useEffect(() => {
    if (id) {
      ...
      const interval = setInterval(checkActiveMeeting, 30000); // Check every 30 seconds
  ...
  const formatCountdown = () => {
    ...
    if (community.status === 'waiting')  {
      return getTimeUntilStart(community.start_date);
    } else if (community.status === 'active') {
      const daysLeft = getDaysLeft(community.end_date);
  ...
  const tabs = [
    ...
    { id: 'reports', label: 'Reports', icon: Vote },
              ...
              <div className="space-y-8">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
                  ...
                  <div className="text-right">
                    <div className="text-3xl font-bold text-primary-600 mb-1">{formatCountdown()}</div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-gray-50 rounded-xl p-6">
                    <h3 className="text-lg font-semibold text-gray-900 mb-4">Community Analytics</h3>
